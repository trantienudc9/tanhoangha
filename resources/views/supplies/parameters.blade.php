        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center justify-between">
                    <h2 class="text-3xl font-semibold mb-2">{{ $detailProduct->name }} ( <i>{{ $detailProduct->type }}</i> )</h2>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="col-span-2 space-y-2">
                        <div>
                            ...
                            <a href="{{ route('product.detail',$detailProduct->id) }}" title="Thêm sản phẩm" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                                Quay lại
                            </a>
